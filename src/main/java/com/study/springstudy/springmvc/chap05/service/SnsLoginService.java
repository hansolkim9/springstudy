...
public class SnsLoginService {
    ...
    // 카카오 로그인 처리 서비스 로직
    public void kakaoLogin(HashMap<String, Object> requestParams, HttpSession session) {

        // 토큰 발급 요청
        String accessToken = getKakaoAccessToken(requestParams);

        // 발급 받은 토큰으로 사용자 정보 가져오기
    ...
    // 인가코드로 토큰 발급 요청
    private String getKakaoAccessToken(HashMap<String, Object> requestParams) {
