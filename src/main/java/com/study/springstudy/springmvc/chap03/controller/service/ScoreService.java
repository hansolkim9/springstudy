package com.study.springstudy.springmvc.chap03.controller.service;

/*
    컨트롤러와 레파지토리 사이에서 중간처리를 담당
    (트랜잭션 처리, 데이터 가공 처리 등등...)
...
//    private final ScoreRepository repository;
    ...
    // 수정 완료를 위해 서비스클래스에서 dto를 entity로 변환
